...
enum AppCommand
{
	...
	CMD_HELP,
	CMD_EXPORT_BCP,
	CMD_TEXTURING_APPLY_MAIN_LAYERS,
	CMD_TEXTURING_REPLACE_MISSING_TRANSITIONS,
	CMD_TEXTURING_APPLY_INNER_LAYERS,
	CMD_TEXTURING_FIX_SEAMS,
	CMD_TEXTURING_FIX_SEAMS_OLD,
	CMD_TEXTURING_FIX_SEAMS_BOTH,
	CMD_TEXTURING_FEATHER_SEAMS,
	CMD_OBJECTS_DISTRIBUTE,
};
